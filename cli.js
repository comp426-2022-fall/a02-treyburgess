...
if (json) {
	const response = await fetch('https://api.open-meteo.com/v1/forecast?latitude=35.000&longitude=-79.00&daily=weathercode&current_weather=true&temperature_unit=fahrenheit&windspeed_unit=mph&timezone=' + timezone + '&past_days=1');
